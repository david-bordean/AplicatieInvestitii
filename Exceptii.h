...
class ExceptieIndiceInvalid : public ExceptiePortofoliu {
public:
    ExceptieIndiceInvalid(int idx, int total)
        : ExceptiePortofoliu("Indice invalid: " + std::to_string(idx) +
                             " (valid: 1-" + std::to_string(total) + ")") {}
};
